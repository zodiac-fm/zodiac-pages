# AGENTS.md: zodiac-pages (app prototype + public pages)

This repo holds the Zodiac.fm in-app prototype (`inapp/app.html` and the app family) and the public pages, deployed to Vercel at zodiac-pages.vercel.app. It is the SIBLING repo to the main vault at `/Users/michaellovitch/claude-code-accelerator-workspace`.
...
**Cross-agent memory:** durable lessons go in the vault's `AGENT-MEMORY.md`, not here. It is searchable memory, not startup authority; resumable work routes through the project's schema-6 Active State and schema-5 handoff.
