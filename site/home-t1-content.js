/* =====================================================================
   ...
   is one edit HERE — home-t1.html and home-t1-tokens.css never move.
   ...
   Instance selection:  home-t1.html      -> A  (the Neutral Ground words)
                        home-t1.html?c=b  -> B  (proof instance)
   ===================================================================== */
...
/* =====================================================================
   ...
   ===================================================================== */
var ZC_A = {
  title: 'Zodiac.fm · Home Template T1 · Instance A',
  wordmark: 'Zodiac.fm',
  navLinks: [
         ...
         Two moment scenes, one frequency each.  ------------------------ */
  {
    ...
    frames:[
      ...
      {pid:'P-126', pop:'vitality', h:'scene', focal:'70% 22%',
...
/* =====================================================================
   ...
   home-t1.html or home-t1-tokens.css differs between the two.
...
ZC_B.title = 'Zodiac.fm · Home Template T1 · Instance B';
