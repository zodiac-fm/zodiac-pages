/* =====================================================================
   ...
   is one edit HERE — home-t5.html and home-t5-tokens.css never move.
   ...
   Instance selection:  home-t5.html      -> A
                        home-t5.html?c=b  -> B  (proof instance)
   ===================================================================== */
...
/* =====================================================================
   ...
   ===================================================================== */
var ZC_A = {
  title: 'Zodiac.fm · Home Template T5 · Instance A',
  wordmark: 'Zodiac.fm',
  navLinks: [
         ...
         the sky of the picture. ---------------------------------------- */
  {
    ...
    frames:[{
      pid:'P-165', h:'hero', focal:'52% 46%', focalM:'50% 50%', freq:'core',
      sky:'top', jb:'w',
      src:T4 + 'p-165-rooftop-violet-scarf.jpg',
      srcMobile:T5 + 'p-165-hero-phone.jpg',
  ...
  /* ---- 2 · VOICES — the first magazine spread ------------------------ */
  {
    ...
    scene:{pid:'P-172', h:'spread', focal:'50% 52%', focalM:'34% 54%', zoomM:1.08, jb:'w', jbh:'30%',
         ...
         image in white Switzer. No coloured labels. ------------------- */
  {
    ...
    cells:[
      ...
      {pid:'P-179', src:T5 + 'p-179-garage-rose-door.jpg', h:'step',
  ...
  /* ---- 5 · WORLD TWO. The day. --------------------------------------- */
  {
    ...
    frames:[
      {pid:'P-93', h:'scene', focal:'52% 40%', focalM:'52% 34%', zoom:1.10, zoomM:1.16,
       jt:'w', jth:'34%', jb:'w', jbh:'30%', freq:'core',
       src:'assets/sg5lib/r29-m-runners-bridge.jpg',
       alt:'Four runners crossing a bridge in hard midday sun, their vests violet, emerald, amber and rose, long shadows on the deck'},
      {pid:'P-169', h:'scene', focal:'64% 26%', focalM:'67% 21%', zoom:1.65, zoomM:1.86,
       jt:'w', jth:'32%',
      ...
      {pid:'P-167', h:'scene', focal:'80% 70%', focalM:'88% 80%', zoom:1.6, zoomM:1.86, jb:'k',
       src:T4 + 'p-167-pier-amber-board.jpg',
  ...
  /* ---- 5b · STRIP joined to World two: the afternoon and the moments -- */
  {
    ...
    cells:[
      {pid:'P-106', src:'assets/d4i/d4i-dance.jpg', h:'scene', focal:'48% 60%', focalM:'44% 70%',
       zoom:1.3, zoomM:1.52,
      ...
      {pid:'P-175', src:T5 + 'p-175-rooftop-emerald-ball.jpg', h:'scene', focal:'34% 44%', focalM:'26% 46%',
       zoom:1.1, zoomM:1.18,
      ...
      {pid:'P-177', src:T5 + 'p-177-rooftop-rose-kite.jpg', h:'scene', focal:'56% 44%', focalM:'58% 44%',
       jb:'w', jbh:'28%',
       alt:'A man in headphones flying a big rose kite from a rooftop in hard afternoon sun, the city behind him'}
    ]
  },
  ...
  /* ---- 6 · VOICES (results, part one) — the second spread ------------- */
  {
    ...
    scene:{pid:'P-171', h:'spread', focal:'50% 44%', focalM:'48% 44%', jt:'w', jth:'26%', jb:'k',
      src:T4 + 'p-171-rooftop-rose-parasol.jpg',
         ...
         against the two above: a wall standing on the white burst ------ */
  {
    ...
    scene:{pid:'P-170', h:'spread', focal:'50% 34%', focalM:'56% 22%', jt:'w', jth:'26%', jb:'w', jbh:'26%',
      src:T4 + 'p-170-beach-emerald-umbrella.jpg',
  ...
  /* ---- 9 · WORLD THREE. The light goes. ------------------------------- */
  {
    ...
    frames:[
      {pid:'P-118', h:'night', focal:'62% 48%', focalM:'70% 50%', zoom:1.18, zoomM:1.44, jt:'k', jth:'34%', jb:'k', freq:'love',
  ...
  /* ---- 9b · STRIP inside the night ------------------------------------ */
  {
    ...
    cells:[
      {pid:'P-109', src:'assets/d4h/d4h-rain-sill.jpg', h:'tall', focal:'44% 66%', focalM:'40% 74%', zoom:1.24, zoomM:1.30, jt:'k', jb:'k',
      ...
      {pid:'P-110', src:'assets/d4h/d4h-record.jpg', h:'tall', focal:'32% 46%', focalM:'29% 44%', zoom:1.45, zoomM:1.74, jt:'k', jb:'k',
  ...
  /* ---- 11 · CLOSE. Out of the night into white. ------------------------ */
  {
    ...
    frames:[{
      pid:'P-130', h:'close', focal:'center 50%', focalM:'48% 33%', zoom:1.2, zoomM:1.66, jt:'w', jth:'30%', freq:'abundance',
...
/* =====================================================================
   ...
   home-t5.html or home-t5-tokens.css differs between the two.
...
ZC_B.title = 'Zodiac.fm · Home Template T5 · Instance B';
...
(function (b) {
  ...
  byId('top').frames[0] = {
    pid:'P-166', h:'hero', focal:'50% 50%', focalM:'50% 50%', freq:'core',
    sky:'top', jb:'w',
    src:T4 + 'p-166-pool-violet-ring.jpg',
    srcMobile:T5 + 'p-166-hero-phone.jpg',
