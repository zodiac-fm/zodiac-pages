/* =====================================================================
   ...
   is one edit HERE — home-t3.html and home-t2-tokens.css never move.
   ...
   Instance selection:  home-t3.html      -> A  (the Neutral Ground words)
                        home-t3.html?c=b  -> B  (proof instance)
   ===================================================================== */
...
/* =====================================================================
   ...
   ===================================================================== */
var ZC_A = {
  title: 'Zodiac.fm · Home Template T3 · Instance A',
  wordmark: 'Zodiac.fm',
  navLinks: [
  ...
  /* THE DAY: each hour is a straight band of the sheet, named by where it
     falls. THE SUN: light over the hour that owns it, screen blend only. */
  light: [
    {tone:'afternoon', from:'#world-brass', fadeIn:'--band-in-soft', fadeOut:'--band-out-soft'},
    {tone:'night',     from:'#night-frame', to:'#story', contain:true},
    {tone:'dawn',      from:'#story', to:'#story', fadeIn:'--band-in-soft', fadeOut:'--band-out', contain:true}
  ],
  bloom: [
    {at:'#hero-frame',  kind:'high',    pad:150, grow:1.22, img:'assets/d4l/d4l-sun-beam-fold.png'},
    {at:'#world-anchor',kind:'morning', pad:40,  grow:1.05},
    {at:'#world-brass', kind:'lowleft', pad:70,  grow:1.10, img:'assets/d4e/d4e-sun-beam-h8.png', opacity:.9},
    {at:'#close-frame', kind:'full',    pad:110, grow:1.18, img:'assets/d4l/d4l-sun-beam-finale.png'}
  ],
  ...
  /* ---- 1 · WORLD ONE. The anchor scene: all four wheel colours together. -- */
  {
    ...
    frames:[{
      pid:'P-163', h:'hero', focal:'50% 40%', focalM:'63% 40%', dt:0, db:.45, fid:'hero-frame',
         ...
         Two moment scenes, one frequency each.  ------------------------ */
  {
    ...
    frames:[
      {pid:'P-93', pop:'quad', h:'scene', focal:'50% 52%', grade:'none', fid:'world-anchor',
      ...
      {pid:'P-126', pop:'vitality', h:'scene', focal:'70% 34%', dt:1, db:1, fid:'world-brass',
  ...
  {
    t:'voices', variant:'wall', id:'more-results', marquee:MARQUEE,
    cue:'07 · More Results',
  ...
  /* ---- 9 · WORLD THREE. The light falls on the same sand. ------------- */
  {
    ...
    frames:[
      {pid:'P-118', pop:'love', h:'night', focal:'50% 42%', dusk:'in', fid:'night-frame',
  ...
  {
    t:'strip', id:'music-strip', join:true, night:true,
    cells:[
  ...
  /* ---- 10 · STRIP (the origin) ---------------------------------------- */
  {
    t:'strip', id:'story', aside:true, night:true, tail:true,
  ...
  /* ---- 11 · CLOSE. The second anchor: all four wheel colours. --------- */
  {
    ...
    frames:[{
      pid:'P-130', h:'close', focal:'center 58%', fid:'close-frame',
...
/* =====================================================================
   ...
   home-t3.html or home-t2-tokens.css differs between the two.
...
ZC_B.title = 'Zodiac.fm · Home Template T3 · Instance B';
